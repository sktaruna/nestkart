"""
================================================================================
NestKart Mock API Server — v2.1.0
================================================================================
...
def issue_replacement(return_id):
    ...
    Fin may call autonomously only for verified damage claims under $300.
    Body: { "customer_id": "cust_xxx", "reason": "<accepted_reason>" }
    """
    ret = RETURNS.get(return_id) or DYNAMIC_RETURNS.get(return_id)
    if not ret:
    ...
    return jsonify({
        ...
        "scenarios": {
            ...
            "products": [
                ...
                {"id": "prod_002", "scenario": "Elm Dining Table — OUT OF STOCK, restock_eta 2025-07-14, waitlist open (23 entries)."},
...
if __name__ == "__main__":
    ...
    print(f"NestKart Mock API v2.1.0 — listening on http://0.0.0.0:{port}")
